...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Connect a database and email provider here before launch. Do not use the
    // function filesystem for orders; Vercel Functions are stateless.
    return res.status(200).json({
      verified: true,
      ticketNumber: 'GT-' + transaction.reference,
